...
bool ImGui::InputUByte(const char* label, ImU8* v, int step, int step_fast, ImGuiInputTextFlags flags)
{
...
bool ImGui::InputUShort3(const char* label, ImU16 v[3], ImGuiInputTextFlags flags)
{
    return InputScalarN(label, ImGuiDataType_U16, v, 3, NULL, NULL, "%d", flags);
}
...
bool ImGui::InputShort3(const char* label, ImS16 v[3], ImGuiInputTextFlags flags)
{
